# Metadatos de Capa: Marginación por colonia (Jocotepec)
...
| Campo | Valor |
|-------|-------|
| **Nombre de la capa** | `marginacion-colonia-jocotepec` |
...
| Campo | Valor |
|-------|-------|
| **Fuente original** | CONAPO Jalisco - Índice de Marginación Urbana por Colonia 2020 (IMC2020CONAPOJAL) |
...
| Campo | Valor |
|-------|-------|
| **Descripción del proceso** | Recorte del índice de marginación urbana por colonia (CONAPO/CONAPO Jalisco 2020) al municipio de Jocotepec. |
...
Ver tabla de atributos original de la fuente (CONAPO Jalisco - Índice de Marginación Urbana por Colonia 2020 (IMC2020CONAPOJAL)). No se renombraron columnas al incorporar esta capa.
...
- **Archivo GeoJSON**: `marginacion-colonia-jocotepec.geojson`
- **Repositorio Git**: `semestre-2026-2/datos/marginacion-colonia-jocotepec/`
