# Metadatos de Capa: Manzanas censales (Jocotepec)
...
| Campo | Valor |
|-------|-------|
| **Nombre de la capa** | `manzanas-jocotepec` |
...
| Campo | Valor |
|-------|-------|
| **Fuente original** | INEGI - Censo de Población y Vivienda 2020 (SCINCE), manzanas |
...
| Campo | Valor |
|-------|-------|
| **Descripción del proceso** | Recorte de manzanas SCINCE 2020 al municipio de Jocotepec. Capa pesada en atributos (>140 campos POBxx); se dejó oculta por defecto en el visor (visible=false) para no saturar la carga inicial. |
| **Transformaciones aplicadas** | Reproyección con GDAL/ogr2ogr de la proyección de origen a EPSG:4326 para el visor web. |
| **Datos faltantes o limitaciones** | Tabla de atributos extensa (catálogo censal completo); revisar si conviene reducir columnas antes de usarla en clase. |
...
Ver tabla de atributos original de la fuente (INEGI - Censo de Población y Vivienda 2020 (SCINCE), manzanas). No se renombraron columnas al incorporar esta capa.

Total de entidades: 590
...
- **Archivo GeoJSON**: `manzanas-jocotepec.geojson`
- **Repositorio Git**: `semestre-2026-2/datos/manzanas-jocotepec/`
