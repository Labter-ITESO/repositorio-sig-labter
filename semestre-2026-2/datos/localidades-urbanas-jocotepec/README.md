# Metadatos de Capa: Localidades urbanas (Jocotepec)
...
| Campo | Valor |
|-------|-------|
| **Nombre de la capa** | `localidades-urbanas-jocotepec` |
...
| Campo | Valor |
|-------|-------|
| **Descripción del proceso** | Recorte de localidades urbanas SCINCE 2020 al municipio de Jocotepec. |
| **Transformaciones aplicadas** | Reproyección con GDAL/ogr2ogr de la proyección de origen a EPSG:4326 para el visor web. |
| **Datos faltantes o limitaciones** | Igual que localidades rurales: campos POBxx sin renombrar. |
...
- **Archivo GeoJSON**: `localidades-urbanas-jocotepec.geojson`
- **Repositorio Git**: `semestre-2026-2/datos/localidades-urbanas-jocotepec/`
