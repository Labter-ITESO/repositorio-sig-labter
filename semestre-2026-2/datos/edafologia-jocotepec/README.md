# Metadatos de Capa: Edafología (Jocotepec)
...
| Campo | Valor |
|-------|-------|
| **Nombre de la capa** | `edafologia-jocotepec` |
...
| Campo | Valor |
|-------|-------|
| **Fuente original** | INEGI - Carta Edafológica (1:250,000) |
...
| Campo | Valor |
|-------|-------|
| **Descripción del proceso** | Recorte de la carta edafológica INEGI al municipio de Jocotepec. |
...
Ver tabla de atributos original de la fuente (INEGI - Carta Edafológica (1:250,000)). No se renombraron columnas al incorporar esta capa.
...
- **Archivo GeoJSON**: `edafologia-jocotepec.geojson`
- **Repositorio Git**: `semestre-2026-2/datos/edafologia-jocotepec/`
