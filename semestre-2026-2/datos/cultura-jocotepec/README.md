# Metadatos de Capa: Cultura (Jocotepec)
...
| Campo | Valor |
|-------|-------|
| **Nombre de la capa** | `cultura-jocotepec` |
...
| Campo | Valor |
|-------|-------|
| **Fuente original** | INEGI - DENUE (Directorio Estadístico Nacional de Unidades Económicas) |
...
| Campo | Valor |
|-------|-------|
| **Descripción del proceso** | Extracción DENUE (corte 14/04/2026) de unidades económicas de cultura/espectáculos en Jocotepec. |
| **Transformaciones aplicadas** | Reproyección con GDAL/ogr2ogr de la proyección de origen a EPSG:4326 para el visor web. |
| **Datos faltantes o limitaciones** | El DENUE se actualiza trimestralmente; esta captura corresponde a abril 2026. |
...
Ver tabla de atributos original de la fuente (INEGI - DENUE (Directorio Estadístico Nacional de Unidades Económicas)). No se renombraron columnas al incorporar esta capa.
...
- **Archivo GeoJSON**: `cultura-jocotepec.geojson`
- **Repositorio Git**: `semestre-2026-2/datos/cultura-jocotepec/`
