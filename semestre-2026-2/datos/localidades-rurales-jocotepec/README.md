# Metadatos de Capa: Localidades rurales (Jocotepec)
...
| Campo | Valor |
|-------|-------|
| **Nombre de la capa** | `localidades-rurales-jocotepec` |
...
| Campo | Valor |
|-------|-------|
| **Fuente original** | INEGI - Censo de Población y Vivienda 2020 (SCINCE) |
...
| Campo | Valor |
|-------|-------|
| **Descripción del proceso** | Recorte de localidades rurales SCINCE 2020 al municipio de Jocotepec. |
| **Transformaciones aplicadas** | Reproyección con GDAL/ogr2ogr de la proyección de origen a EPSG:4326 para el visor web. |
| **Datos faltantes o limitaciones** | Los campos POBxx corresponden al catálogo de indicadores SCINCE 2020; no están renombrados a texto plano (consultar diccionario de datos INEGI). |
...
Ver tabla de atributos original de la fuente (INEGI - Censo de Población y Vivienda 2020 (SCINCE)). No se renombraron columnas al incorporar esta capa.

Total de entidades: 46
...
- **Archivo GeoJSON**: `localidades-rurales-jocotepec.geojson`
- **Repositorio Git**: `semestre-2026-2/datos/localidades-rurales-jocotepec/`
