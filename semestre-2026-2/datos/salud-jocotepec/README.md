# Metadatos de Capa: Salud (Jocotepec)
...
| Campo | Valor |
|-------|-------|
| **Nombre de la capa** | `salud-jocotepec` |
...
| Campo | Valor |
|-------|-------|
| **Descripción del proceso** | Extracción DENUE (corte 14/04/2026) de unidades económicas de salud en Jocotepec, con capa de cobertura a 800 m generada por separado (no incluida en este base). |
...
- **Archivo GeoJSON**: `salud-jocotepec.geojson`
- **Repositorio Git**: `semestre-2026-2/datos/salud-jocotepec/`
