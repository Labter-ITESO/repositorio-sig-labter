# Metadatos de Capa: Límite municipal (Jocotepec)
...
| Campo | Valor |
|-------|-------|
| **Nombre de la capa** | `limite-municipal-jocotepec` |
...
| Campo | Valor |
|-------|-------|
| **Fuente original** | INEGI - Marco Geoestadístico |
...
| Campo | Valor |
|-------|-------|
| **Descripción del proceso** | Recorte del Marco Geoestadístico de INEGI al polígono municipal de Jocotepec, dentro del proyecto de análisis municipal Jocotepec (curso PAP). Reincorporado aquí como capa base para el repositorio SIG PAP LABTER. |
| **Transformaciones aplicadas** | Reproyección con GDAL/ogr2ogr de la proyección de origen a EPSG:4326 para el visor web. |
| **Datos faltantes o limitaciones** | Ninguna conocida; verificar vigencia del límite oficial si se requiere precisión legal. |
...
Ver tabla de atributos original de la fuente (INEGI - Marco Geoestadístico). No se renombraron columnas al incorporar esta capa.
...
- **Archivo GeoJSON**: `limite-municipal-jocotepec.geojson`
- **Repositorio Git**: `semestre-2026-2/datos/limite-municipal-jocotepec/`
