# Metadatos de Capa: Uso de suelo y vegetación (Jocotepec)
...
| Campo | Valor |
|-------|-------|
| **Nombre de la capa** | `uso-suelo-vegetacion-jocotepec` |
...
| Campo | Valor |
|-------|-------|
| **Fuente original** | INEGI - Uso de Suelo y Vegetación, Serie V (1:250,000) |
...
| Campo | Valor |
|-------|-------|
| **Descripción del proceso** | Recorte de la carta de uso de suelo y vegetación Serie V de INEGI al municipio de Jocotepec. |
| **Transformaciones aplicadas** | Reproyección con GDAL/ogr2ogr de la proyección de origen a EPSG:4326 para el visor web. |
| **Datos faltantes o limitaciones** | Escala fuente 1:250,000. |
...
Ver tabla de atributos original de la fuente (INEGI - Uso de Suelo y Vegetación, Serie V (1:250,000)). No se renombraron columnas al incorporar esta capa.

Total de entidades: 42
...
- **Archivo GeoJSON**: `uso-suelo-vegetacion-jocotepec.geojson`
- **Repositorio Git**: `semestre-2026-2/datos/uso-suelo-vegetacion-jocotepec/`
